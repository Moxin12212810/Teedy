...
create cached table T_REGISTRATION_REQUEST ( RRE_ID_C varchar(36) not null, RRE_EMAIL_C varchar(255) not null, RRE_USERNAME_C varchar(50) not null, RRE_PASSWORD_C varchar(255) not null, RRE_STATUS_C varchar(20) not null default 'PENDING', RRE_CREATEDATE_D datetime not null, RRE_UPDATEDATE_D datetime not null, RRE_PROCESSDATE_D datetime, RRE_PROCESSEDBY_C varchar(36), RRE_COMMENT_C varchar(1000), RRE_REASON_C varchar(1000), primary key (RRE_ID_C));
create memory table T_MESSAGE ( MSG_ID_C varchar(36) not null, MSG_IDFROM_C varchar(50) not null, MSG_IDTO_C varchar(50) not null, MSG_CONTENT_C varchar(4000) not null, MSG_STATUS_C varchar(20) not null, MSG_CREATEDATE_D datetime not null, primary key (MSG_ID_C) ); 
